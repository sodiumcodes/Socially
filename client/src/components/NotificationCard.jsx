            ...
            <div className="flex items-center gap-6">
                ...
                <div className="flex-1 min-w-0">
                    <div className="flex flex-col gap-1">
                        <div className="flex items-center gap-2">
                            <h3
                                className="font-black text-foreground text-lg leading-tight tracking-tight cursor-pointer hover:text-primary transition-colors"
                        ...
                        <div className="flex items-center gap-4 mt-1">
                            <span className="flex items-center gap-1.5 text-[11px] font-bold text-muted-foreground">
                                <GraduationCap size={12} className="text-icon" /> {sender.batch || '20XX'}
                            </span>
                            <span className="flex items-center gap-1.5 text-[11px] font-bold text-muted-foreground">
                                <Building2 size={12} className="text-medium-slate-blue-400" /> {sender.branch || 'None'}
                            </span>
                            <span className="flex items-center gap-1.5 text-[11px] font-bold text-muted-foreground">
                ...
                <div className="flex items-center gap-2">
                    <button
                        ...
                        className="p-3 bg-muted hover:bg-cayenne-red-500/10 hover:text-cayenne-red-500 text-muted-foreground rounded-2xl transition-all border border-border group/decline"
                        title="Decline"
                    >
                        <X size={18} />
                    </button>
                    <button
                        ...
                        className="flex items-center justify-between gap-3 px-6 py-3 btn-cta rounded-2xl transition-all shadow-md group/btn"
                    >
